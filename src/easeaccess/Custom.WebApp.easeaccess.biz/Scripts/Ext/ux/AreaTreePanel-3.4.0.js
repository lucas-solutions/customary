...
//http://www.sencha.com/forum/showthread.php?9175-eXtplorer-PHP-ExtJS-based-File-Manager
//http://ahlearns.wordpress.com/2013/02/05/ext-js-4-a-file-browser-with-spring-3-server-side/

/*global Ext, window, document, setTimeout */

/**
* @class Ext.ux.AreaTreePanel
* @extends Ext.tree.TreePanel
*/

Ext.ux.AreaTreePanel = Ext.extend(Ext.tree.TreePanel, {

    /**
    * @cfg {String} application id that is root of this tree (defaults to 'localhost')
    */
    ...
    // {{{
    /**
    * @cfg {Object} baseParams This object is not used directly by AreaTreePanel but it is
    ...
    */
    ...
    /**
    * @cfg {Boolean} true to expand root node on AreaTreePanel render (defaults to true)
    */
    expandOnRender: true,
    ...
    */
    initComponent: function () {
        ...
        Ext.apply(this, {
            ...
            dropConfig: this.dropConfig ? this.dropConfig : {
                ...
                appendOnly: true, // sorting
                expandDelay: 3600000 // do not expand on drag over node
            },

            // create treeSorter
            treeSorter: new Ext.tree.TreeSorter(this, {
                dir: "asc",
                property: "type",
                folderSort: true,
                sortType: function (value, node) {
                    ...
                    if (node && node.attributes.type) {
                        return node.attributes.type.concat(value);
                    }
                    return value;
                }
            }),
        ...
        if (!this.loader) {
            this.loader = new Ext.tree.TreeLoader({
                ...
                listeners: {
                    beforeload: {
                        scope: this, fn: function (loader, node) {
                            loader.dataUrl = this.url + '/' + this.getPath(node);
        ...
        // call parent
        Ext.ux.AreaTreePanel.superclass.initComponent.apply(this, arguments);
        ...
        this.addEvents(
            ...
            * @param {Ext.ux.AreaTreePanel} this
    ...
    onRender:function() {
        // call parent
        Ext.ux.AreaTreePanel.superclass.onRender.apply(this, arguments);
...
//              ,menu:this.getContextMenu()
    ...
    getPath: function(node) {
        var path, p, a = [node.attributes.name, node.attributes.path];
        ...
        if(node !== this.root) {
            ...
            while(p && p !== this.root) {
                a.unshift(p.attributes.name);
                p = p.parentNode;
            }
            a.unshift(this.root.attributes.name || '');
        }
    ...
    // {{{
    /**
     * Destroys the AreaTreePanel and sub-components
     * @private
     */
    onDestroy:function() {
        ...
        // call parent
        Ext.ux.AreaTreePanel.superclass.onDestroy.call(this);
    ...
    * @return {Ext.ux.AreaTreePanel} this
    */
...
// register xtype
Ext.reg('areatreepanel', Ext.ux.AreaTreePanel);
