...
/**
 * @class Ext.ux.AreaTreeMenu
 * @extends Ext.menu.Menu
 * @constructor
 * Creates new AreaTreeMenu object
 * @param {Object} config A configuration object
 */
Ext.ux.AreaTreeMenu = function(config) {
    config = config || {};
    ...
    // call parent
    Ext.ux.AreaTreeMenu.superclass.constructor.call(this, config);
...
Ext.extend(Ext.ux.AreaTreeMenu, Ext.menu.Menu, {
...
// register xtype
Ext.reg('areatreemenu', Ext.ux.AreaTreeMenu);
