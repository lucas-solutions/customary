Ext.define('App.ux.AreasPanel', function () {
    ...
    return {
                ...
                listeners: {
                    ...
                    selectionchange: {
                        fn: function (item, selected) {
                            if (selected[0]) {
                                this.onGridSelectionChange(item, selected);
                            }
                        },
                        scope: this
                    }
        ...
        tools: [
            { type: 'search', qtip: "search by column" },
            { type: 'maximize', qtip: "open edit dialog" },
            { type: 'refresh', qtip: "refresh grid" }],

        onGridSelectionChange: function (item, selected) {
            this.edit.show();
