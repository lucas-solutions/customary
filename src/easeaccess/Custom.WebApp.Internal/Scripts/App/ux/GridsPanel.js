Ext.define('App.ux.GridsPanel', function () {
    ...
    return {
        ...
        initComponent: function (config) {
            ...
            this.form = Ext.create('App.ux.GridForm', { path: path });
            ...
            this.edit = Ext.create('Ext.window.Window', {
                ...
                listeners: {
                    ...
                    initComponent: function () {
                        ...
                        App.ux.GridsPanel.superclass.initComponent.apply(this, arguments);
                    }*/
            });

            /*this.grid = GridsGrid.create({
                scope: this,
                path: path,
