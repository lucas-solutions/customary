...
namespace Custom
{
    ...
    public static class DocumentContextExtensions
    {
        ...
        public static RavenJToken Create(this DocumentContext context, RavenJToken source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            switch (source.Type)
            {
        ...
        public static RavenJArray Create(this DocumentContext context, RavenJArray source, ModelDefinition descriptor, List<Annotation> annotations)
        {
        ...
        public static RavenJObject Create(this DocumentContext context, RavenJObject source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            Guid idValue;
            RavenJToken idToken;
        ...
        public static RavenJToken Destroy(this DocumentContext context, RavenJToken source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            switch (source.Type)
            {
                case JTokenType.Array:
        ...
        public static RavenJArray Destroy(this DocumentContext context, RavenJArray source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            var array = new RavenJArray();
        ...
        public static RavenJObject Destroy(this DocumentContext context, RavenJObject source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            Guid idValue;
            RavenJToken idToken;
            if (source.TryGetValue(IdProperty, out idToken) && idToken.Type == JTokenType.Guid)
        ...
        public static List<RavenJObject> Read(this DocumentContext context, ModelDefinition descriptor, string query, int? start, int? limit, List<Annotation> annotations)
        {
        ...
        public static RavenJToken Update(this DocumentContext context, RavenJToken source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            switch (source.Type)
            {
                case JTokenType.Array:
        ...
        public static RavenJArray Update(this DocumentContext context, RavenJArray source, ModelDefinition descriptor, List<Annotation> annotations)
        {
            var array = new RavenJArray();
        ...
        public static RavenJObject Update(this DocumentContext context, RavenJObject source, ModelDefinition descriptor, List<Annotation> annotations)
        {
        ...
        public static RavenJObject UpdateObject(this RavenJObject targetObject, RavenJObject sourceObject, ModelDefinition objectDescriptor, List<Annotation> annotations)
        {
            foreach (var property in objectDescriptor.Properties)
            {
                ...
                else if (propertyType is ModelDefinition)
                {
                    if (!sourceValue.IsPrimitive())
                    {
        ...
        public static string GetFamilyName(this ModelDefinition descriptor)
        {
            if (!string.IsNullOrWhiteSpace(descriptor.Extend))
            {
                var parent = Global.Metadata.Describe(descriptor.Extend) as ModelDefinition;
